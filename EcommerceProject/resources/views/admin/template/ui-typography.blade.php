...
@section('title', 'Typography UI - Sneat Admin')
                    ...
                    <div class="card-body">
                        <table class="table table-borderless">
                            <tbody>
                                ...
                                <tr>
                                    <td class="align-middle"><small class="text-light fw-semibold">Deleted Text</small>
                                    </td>
                                    <td class="py-3">
                                        <p class="mb-0"><del>This line of text is meant to be treated as deleted
                                                text.</del></p>
                                    </td>
                                </tr>
                                <tr>
