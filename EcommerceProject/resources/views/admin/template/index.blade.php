...
@section('title', 'Dashboard - Sneat Admin')

@push('styles')
    <link rel="stylesheet" href="{{ asset("admin/assets/libs/apex-charts/apex-charts.css") }}" />
@endpush

@push('scripts')
    <script src="{{ asset("admin/assets/libs/apex-charts/apexcharts.js") }}"></script>
@endpush
