...
@section('title', 'Footer UI - Sneat Admin')
                ...
                <div
                    ...
                    <div>
                        <a href="https://themeselection.com/demo/sneat-bootstrap-html-admin-template/landing/"
                            target="_blank" class="footer-text fw-bolder">Sneat</a>
                        ©
                    </div>
                    <div>
                        ...
                        <div class="dropdown dropup footer-link me-3">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="javascript:void(0);"><i class="bx bx-bitcoin"></i>
                                    Bitcoin</a>
                            </div>
                        </div>
