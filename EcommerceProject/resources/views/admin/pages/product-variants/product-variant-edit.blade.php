<div class="container-xxl flex-grow-1 container-p-y" id="main-component">
    <x-livewire::management-header title="Edit Variant" btn-link="{{ route('admin.products.index') }}" btn-label="Back to List"
    ...
    <x-livewire::form-panel :isFormNormal="false" id="product-variant-edit-form" action="update">
