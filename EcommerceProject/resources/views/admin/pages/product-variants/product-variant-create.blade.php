<div class="container-xxl flex-grow-1 container-p-y" id="main-component">
    <x-livewire::management-header title="Add New Variant" btn-link="{{ route('admin.products.index') }}" btn-label="Back to List"
        btn-icon="fas fa-arrow-left" btn-class="btn btn-outline-secondary bootstrap-focus" />

    <x-livewire::data-selector title="Select Product Variant" id="dataSelectorVariant" resetProperty="selectedVariantId" wire:key="data-selector-variant">
    ...
    <x-livewire::form-panel :isFormNormal="false" id="product-variant-create-form" action="store">
        <x-livewire::form-panel.group title="Variant Information" icon="fas fa-box-open">
            <x-livewire::form-panel.group.input-group label="Variant Name" icon="fas fa-tag" for="name" column="col-md-6" required>
            ...
            <x-livewire::form-panel.group.input-group label="SKU" icon="fas fa-barcode" for="sku" column="col-md-6" required>
            ...
            <x-livewire::form-panel.group.input-group label="Price" icon="fas fa-dollar-sign" for="price" column="col-md-6" required>
            ...
            <x-livewire::form-panel.group.input-group label="Discounted Price" icon="fas fa-percent" for="discount" column="col-md-6">
            ...
            <x-livewire::form-panel.group.input-group label="Stock Quantity" icon="fas fa-boxes" for="stock" column="col-md-6" required>
