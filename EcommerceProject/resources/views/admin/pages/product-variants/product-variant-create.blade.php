<div class="container-xxl flex-grow-1 container-p-y" id="main-component">
    <x-livewire-admin::management-header title="Add New Variant" btn-link="{{ route('admin.products.index') }}" btn-label="Back to List"
    ...
    <x-livewire-admin::form-panel :isFormNormal="false" id="product-variant-create-form" action="store">
