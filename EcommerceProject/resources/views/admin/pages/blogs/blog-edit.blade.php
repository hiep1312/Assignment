...
<div class="container-xxl flex-grow-1 container-p-y" id="main-component">
    <x-livewire-admin::management-header title="Edit Blog" btn-link="{{ route('admin.blogs.index') }}" btn-label="Back to List"
    ...
    <x-livewire-admin::form-panel :isFormNormal="false" id="blog-edit-form" action="update">
