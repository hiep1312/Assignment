...
<div class="container-xxl flex-grow-1 container-p-y" id="main-component">
    <x-livewire-admin::management-header title="Add New Banner" btn-link="{{ route('admin.banners.index') }}" btn-label="Back to List"
    ...
    <x-livewire-admin::form-panel :isFormNormal="false" id="banner-create-form" action="store">
