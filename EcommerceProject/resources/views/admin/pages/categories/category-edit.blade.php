<div class="container-xxl flex-grow-1 container-p-y" id="main-component">
    <x-livewire::management-header title="Edit Category" btn-link="{{ route('admin.categories.index') }}" btn-label="Back to List"
        btn-icon="fas fa-arrow-left" btn-class="btn btn-outline-secondary bootstrap-focus" />

    <x-livewire::form-panel :isFormNormal="false" id="category-edit-form" action="update">
