...
<div class="container-xxl flex-grow-1 container-p-y" id="main-component">
    <x-livewire::management-header title="Edit Notification" btn-link="{{ route('admin.notifications.index') }}" btn-label="Back to List"
    ...
    <x-livewire::form-panel :isFormNormal="false" id="notification-edit-form" action="update">
