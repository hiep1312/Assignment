...
<div class="container-xxl flex-grow-1 container-p-y" id="main-component">
    <x-livewire-admin::management-header title="Edit Notification" btn-link="{{ route('admin.notifications.index') }}" btn-label="Back to List"
    ...
    <x-livewire-admin::form-panel :isFormNormal="false" id="notification-edit-form" action="update">
        ...
        <div class="mb-4 @error('message') is-invalid @enderror">
            ...
            <div wire:ignore wire:key="notification-message">
                <textarea class="form-control" id="ckeditor" data-model="message" data-label="Message Editor"
                    data-placeholder="Enter notification message" rows="5">{{ $message }}</textarea>
            </div>
