...
<div class="container-xxl flex-grow-1 container-p-y" id="main-component">
    <x-livewire-admin::management-header title="Edit User" btn-link="{{ route('admin.users.index') }}" btn-label="Back to List"
        btn-icon="fas fa-arrow-left" btn-class="btn btn-outline-secondary bootstrap-focus" />

    <x-livewire-admin::form-panel :isFormNormal="false" id="user-edit-form" action="update">
